...
%$which varies as a function of redshift increasing from low to high redshift from $\alpha = -1.06$ to $\alpha = -0.62$, and an exponential cutoff which, while uncertain, is roughly $W_* = 3~\mathrm{\AA}$. DISCUSS DIFFERENCES.
