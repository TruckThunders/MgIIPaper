...
\altaffiltext{1}{New Mexico State University, Las Cruces, NM 88003, United States}
...
\begin{figure*}[bth]
\epsscale{1.17}
\plottwo{hist_z_MgII_dndz.pdf}{hist_z_MgII_dndx.pdf}
...
\begin{figure*}[bth]
\epsscale{1.17}
\plottwo{hist_nsigma_MgII_dndx.pdf}{hist_epsilon_MgII_dndx.pdf}
...
\begin{figure*}[bth]
\epsscale{1.17}
\plottwo{hist_ew_MgII_dndz.pdf}{hist_ew_MgII_dndx.pdf}
...
\begin{figure*}[bth]
\epsscale{1.17}
\plottwo{hist_logN_MgII_dndz.pdf}{hist_logN_MgII_dndx.pdf}
...
\begin{figure*}[bth]
\epsscale{1.17}
\plottwo{hist_ew_MgII_strongz.pdf}{cdf_fw.pdf}
...
\begin{figure}[bth]
\epsscale{2.25}
\plottwo{hist_z_MgII_dndz_between.pdf}{hist_z_MgII_dndx_between.pdf}
...
\begin{figure}[bth]
\epsscale{1.2}
\plotone{hist_ew_MgII_totalz.pdf}
